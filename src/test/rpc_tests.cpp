...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_THROW(FeeRateFromValueInSatB(ValueFromString("1.111111111")), UniValue);
    BOOST_CHECK_THROW(FeeRateFromValueInSatB(ValueFromString("11111111111")), UniValue);
}
