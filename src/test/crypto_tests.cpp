    ...
    public:
        MuHashOverflow() {
            for (int i = 0; i < Num3072::LIMBS; ++i) {
                data.limbs[i] = std::numeric_limits<Num3072::limb_t>::max();
            }
        }
    };
    MuHashOverflow overflowchk;
    unsigned char out3[384];
    overflowchk.Finalize(out3);
    std::string overflow_exp{""};
    BOOST_CHECK_EQUAL(HexStr(out3), overflow_exp);
}
